Source: https://notesbylex.com/openclaw-the-missing-piece-for-obsidians-second-brain
Fetched: 2026-08-01T10:37:36

Title: OpenClaw: the missing piece for Obsidian's second brain

URL Source: http://notesbylex.com/openclaw-the-missing-piece-for-obsidians-second-brain

Markdown Content:
![Image 1](https://notesbylex.com/_media/openclaw-and-obsidian/openclaw-and-obsidian-cover.png)

I've been an Obsidian user for many years. I like it a lot. I like the paradigm of linking notes that comes from [Zettelkasten](https://notesbylex.com/zettelkasten). I like having a single place to keep all my notes, to track progress on my goals and so forth.

My workflow is pretty simple. I just create a new Daily Note every day; it contains my todo list and notes I take throughout the day. I also use [Permanent Notes](https://notesbylex.com/permanent-notes) to keep track of ideas and link them to daily notes, I also use these notes to help me learn and memorise new concepts. When I have a note that I feel is meaty enough, I'll move it to a [public repo](https://github.com/lextoumbourou/notes) which is published on my blog, so I kind of have a system for blogging, albeit I end up with this pretty odd thing, that's somewhere in between a blog and a half-baked personal Wiki. I also have folders for tracking people in my life (particularly birthdays, gift ideas, and various things I want to remember about them), as well as using them for life admin tasks, like managing house repairs, insurance, and so on.
...
![Image 2: Simcard and phone I used to setup WhatsApp](https://notesbylex.com/_media/openclaw-and-obsidian/openclaw-simcard-for-whatsapp.jpeg)

![Image 3: First conversation with M](https://notesbylex.com/_media/openclaw-and-obsidian/whatsapp-first-chat.jpg)
...
![Image 4: Morning check-in via WhatsApp](https://notesbylex.com/_media/openclaw-and-obsidian/whatsapp-morning-checkin.jpg)
...
![Image 5: Weight tracking summary](https://notesbylex.com/_media/openclaw-and-obsidian/openclaw-weight-tracking-example.png)
...
![Image 6: Macros and Calorie tracking](https://notesbylex.com/_media/openclaw-and-obsidian/openclaw-calorie-tracking-example.png)
...
![Image 7: openclaw-calorie-log.png](https://notesbylex.com/_media/openclaw-and-obsidian/openclaw-calorie-log.png)
