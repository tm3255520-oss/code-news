Source: https://clawhub.ai/eddiewang-zhhx/obsidian-llm-wiki
Fetched: 2026-08-01T10:39:01

Title: obsidian-llm-wiki — ClawHub

URL Source: http://clawhub.ai/eddiewang-zhhx/obsidian-llm-wiki
...
3.   **运行初始化脚本**或手动创建目录
4.   **创建目录结构**：创建 raw/ 和 wiki/ 子目录
5.   **创建模板文件**：写入 entity/topic/source 模板
6.   **创建 index.md 和 log.md**
7.   **记录 vault 名称**：写入 `~/.llm-wiki-vault` 方便后续复用
...
> 发现断链后，立即创建对应实体页，用 write_to_file 写入 创建后记得更新 index.md 和 log.md
